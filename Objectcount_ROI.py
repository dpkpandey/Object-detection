...
class ObjectCounter:
    ...
    def process_frame(self, frame):
        ...
        # Define Region of Interest (ROI) - Adjust coordinates as needed, as this is most important part if we have a plan to count object in fixed certain area.s
        ...
        for info in results:
            ...
            for box in boxes:
                ...
                # Filter detections by confidence and check if centroid is within ROI
                if conf > 0.2 and roi_x1 < cx < roi_x2 and roi_y1 < cy < roi_y2:
        ...
        cvzone.putTextRect(frame, f'Detected object No = {len(self.counter_up)}', [80, 34], 
